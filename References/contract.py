    ...
    try:
        ...
        df_dict = {
            name: df for name, df in {
                "Contract_return": return_df,
                "Contract_returnproducts": return_products_df,
                "Contract_details": details_df
...
if __name__ == "__main__":
    DATA_URL = "https://smartup.online/b/anor/mxsx/mkf/contract$export"

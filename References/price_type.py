    ...
    try:
        ...
        df_dict = {
            name: df for name, df in {
                "price_type_return": return_df,
                "price_type_group_returnproducts": return_products_df,
                "price_type_group_details": details_df
...
if __name__ == "__main__":
    DATA_URL = "https://smartup.online/b/anor/mxs/mkr/price_type$export"

    ...
    try:
        ...
        df_dict = {
            name: df for name, df in {
                "Workspaces_return": return_df,
                "Workspaces_returnproducts": return_products_df,
                "Workspaces_details": details_df
...
if __name__ == "__main__":
    DATA_URL = "https://smartup.online/b/anor/mxsx/mrf/room$export"
